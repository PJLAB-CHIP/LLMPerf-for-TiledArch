...
class Tx8:
    ...
    def execute(self, i_params, o_params, w_params, cp, cm_size, cm_type, cm_hops):
        ...
        verification_result, verification_flag = self.verification(i_params, o_params, w_params)#要求(1)是否可以计算;True or False
    ...
    def Vector(self, i_params, o_params, w_params, cp, cm_size, cm_type, cm_hops, verification_flag):
        ...
        if verification_flag == 0:
            ...
            time_one_iter_in = input_load_time + dram_read_cycle
    ...
    def GEMM(self, i_params, o_params, w_params, cp, cm_size, cm_type, cm_hops, verification_flag):
        ...
        if i_params[1] <= w_params[1]:
            ...
            input_load_time = w_params[0] * self.config["TILE_NUM"] / self.config["DRAM_BW(GB/s)"] + 0.001 * self.config["DRAM_LATENCY(us)"]
        ...
        if i_params[1] <= w_params[1]:#输入驻留
            ...
            n2 = int(math.ceil(i_params[1]/self.config["TILE_NUM"]))
    ...
    def Vector_GEMM(self, i_params, o_params, w_params, cp, cm_size, cm_type, cm_hops, verification_flag):
        ...
        if verification_flag == 0:
            ...
            time_one_iter_in = input_load_time + dram_read_cycle[1]
    ...
    def GEMM_Vector(self, i_params, o_params, w_params, cp, cm_size, cm_type, cm_hops, verification_flag):
        ...
        if verification_flag == 0:
            ...
            time_one_iter_in = input_load_time + dram_read_cycle[0]
    ...
    def FlashAttention(self, i_params, o_params, w_params, cp, cm_size, cm_type, cm_hops, verification_flag):
        ...
        dram_store_cycle_in = n2 * dram_store_cycle#每一个完整内层循环的DRAM存储数据时间
        latency_cycle_in = input_load_time + dram_read_cycle[1] + cp_latency_cycle_in[1]
        # print(input_load_time,dram_read_cycle[1],cp_latency_cycle_in[1],latency_cycle_in)
        ...
        latency = n1 * latency_cycle_in + dram_store_cycle
        #print(dram_store_cycle,n1)
